...
<template>
    <div class="bg-slate-50 flex h-screen overflow-hidden text-slate-800 antialiased font-sans">
        ...
        <div class="flex-1 flex flex-col h-screen overflow-hidden relative">
            ...
            <!-- FIXED FOOTER -->
            <footer class="shrink-0 bg-white/80 backdrop-blur-md border-t border-slate-100 px-8 py-4 flex flex-col md:flex-row justify-between items-center gap-2 text-slate-400 text-[10px] font-black uppercase tracking-[0.15em] z-20">
