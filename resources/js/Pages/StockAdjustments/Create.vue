...
const fetchWarehouseStocks = async () => {
    ...
    try {
        ...
        // Update system stock and difference for all items
        form.items.forEach(item => {
            if (item.product_id) {
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 font-sans">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-slate-500 font-bold mt-1 uppercase tracking-tight">Buat Dokumen Penyesuaian Stok Baru</p>
                    </div>
                </div>
            </div>
                ...
                <div class="lg:col-span-4 space-y-6">
                    <div class="bg-indigo-900 text-white p-6 md:p-8 rounded-[2.5rem] shadow-2xl shadow-indigo-100">
                        ...
                        >
                            ...
                            <span v-else>Simpan Stock Opname</span>
                        </button>
                    </div>
                </div>
            </div>
