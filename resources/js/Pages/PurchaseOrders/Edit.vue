...
// Safely format date from ISO string
const initialDate = props.purchaseOrder?.tanggal 
    ? (props.purchaseOrder.tanggal.includes('T') ? props.purchaseOrder.tanggal.split('T')[0] : props.purchaseOrder.tanggal.substring(0, 10)) 
    : '';
...
const form = useForm({
    ...
    items: props.purchaseOrder?.items?.map(item => ({
        ...
        subtotal: item.quantity * (parseFloat(item.harga) || 0)
    })) || []
});
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 font-sans">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-slate-500 font-bold mt-1 uppercase tracking-tight">Edit Purchase Order #{{ purchaseOrder.no_po }}</p>
                    </div>
                </div>
            </div>
                ...
                <div class="lg:col-span-8 space-y-8">
                    ...
                    <div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 p-6 md:p-10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-2">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">
                                    Status PO <span class="text-rose-400">*</span>
                                </label>
                ...
                <div class="lg:col-span-4 space-y-6">
                    <div class="bg-indigo-900 text-white p-6 md:p-8 rounded-[2.5rem] shadow-2xl shadow-indigo-100">
                        ...
                        >
                            ...
                            <span v-else>Update Purchase Order</span>
                        </button>
                    </div>
                </div>
            </div>
